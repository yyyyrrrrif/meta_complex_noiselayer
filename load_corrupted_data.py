        ...
        if self.train:
            ...
            if meta is True:
                ...
                if corruption_type == 'unif':
                    ...
                    print(C)
                    self.C = C
                elif corruption_type == 'special_smi':
                    C = special_smi(self.corruption_prob, num_classes)
                    print(C)
                    self.C = C
                elif corruption_type == 'special_nei':
                    C = special_nei(self.corruption_prob, num_classes)
                    print(C)
                    self.C = C
                elif corruption_type == 'flip_nei':
                    C = flip_nei(self.corruption_prob, num_classes)
                    print(C)
                    self.C = C
                elif corruption_type == 'flip_adver':
                    C = flip_adver(self.corruption_prob, num_classes)
                    print(C)
                    self.C = C
                    ...
                    np.save('hierarchical_%s.npy' % corruption_prob, C)
                    self.C = C
